<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yaziGuncelle.aspx.cs" Inherits="fp_dekorasyon.yaziGuncelle" %>
...
<body>
	...
	<div class="main">
		<div class="main-w3l">
			<h1 class="logo-w3">Admin Yazı Güncelleme Formu</h1>
			<div class="w3layouts-main">
				
					<form action="#" method="post" runat="server">
						<asp:TextBox ID="TextBox1" runat="server" placeholder="ID"></asp:TextBox>
                        <asp:TextBox ID="TextBox2" runat="server" placeholder="Hizmet Tanımı"></asp:TextBox>
                        <asp:Button ID="Button1" runat="server" Text="Güncelle" OnClick="Button1_Click"/>
                        &nbsp;
                        <asp:Button ID="Button2" runat="server" Text="Admin Paneline Dön" OnClick="Button2_Click"/>
					</form>
			</div>			
		</div>
	</div>
